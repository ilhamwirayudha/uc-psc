...
@section('title', 'Buat Booking — UC PSC')
@section('page-title', 'Buat Booking / Jadwal Sesi')
@section('page-subtitle', 'Pilih klien, layanan yang sesuai, jadwal sesi, dan penugasan konselor / staff')

@section('content')
<div class="max-w-4xl space-y-6" x-data="{
    serviceType: '{{ old('kategori', $selectedClient->service_type ?? '') }}',
    jenis: '{{ old('jenis', $selectedClient->jenis ?? 'individual') }}',
    clientId: '{{ old('client_id', $selectedClient->id ?? '') }}',
    selectedClient: null,
    searchQuery: '',
    dropdownOpen: false,
    today: '',
    ...
    selectClient(client, shouldOpen = false) {
        ...
        if (client.service_type) {
            this.serviceType = client.service_type;
        }
    },
    ...
    <div class="flex items-center justify-between">
        <a href="{{ route('bookings.index') }}" class="inline-flex items-center gap-2 text-xs font-semibold text-purple-deep hover:text-purple-deep/80 transition">
    ...
    <form action="{{ route('bookings.store') }}" method="POST" class="space-y-6">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-[#EDE1FA] p-6 space-y-5">
            <div class="pb-3 border-b border-[#EDE1FA]">
                <h3 class="text-base font-bold text-purple-deep">Informasi Klien Terdaftar</h3>
                <p class="text-xs text-[#827299] mt-0.5">Cari dan pilih nama klien untuk memuat opsi layanan yang sesuai</p>
            </div>

            <div class="space-y-4">
                {{-- Searchable Input & Dropdown Klien --}}
                <div class="relative" @click.outside="dropdownOpen = false">
                    <label class="block text-xs font-bold text-[#5B4A73] mb-1.5">Pilih Klien Terdaftar <span class="text-red-500">*</span></label>
                    ...
                    <div x-show="dropdownOpen"
                        class="absolute z-50 left-0 right-0 mt-1.5 bg-white border border-[#EDE1FA] rounded-xl shadow-lg max-h-64 overflow-y-auto divide-y divide-gray-50">
                ...
                <div x-show="jenis === 'individual'">
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                        ...
                        <button type="button"
                            ...
                            class="flex items-center gap-3.5 px-4 py-3 rounded-xl border text-left cursor-pointer group">
                            ...
                            <div class="flex-1 min-w-0">
                                ...
                                <p class="text-xs text-[#827299]">Sesi konseling 1-on-1 bersama psikolog/konselor</p>
                            </div>
                        </button>
                        ...
                        <button type="button"
                            ...
                            <div class="flex-1 min-w-0">
                                ...
                                <p class="text-xs text-[#827299]">Asesmen psikologi perorangan (IQ / Kepribadian / Minat)</p>
                            </div>
                        </button>
                    </div>
                </div>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                        ...
                        <button type="button"
                            ...
                            <div class="flex-1 min-w-0">
                                ...
                                <p class="text-xs text-[#827299]">Konseling bersama pasangan, keluarga, atau support group</p>
                            </div>
                        </button>
                        ...
                        <button type="button"
                            ...
                            <div class="flex-1 min-w-0">
                                ...
                                <p class="text-xs text-[#827299]">Asesmen psikologi untuk anggota keluarga / kelompok kecil</p>
                            </div>
                        </button>
                    </div>
                </div>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                        ...
                        <button type="button"
                            ...
                            <div class="flex-1 min-w-0">
                                ...
                                <p class="text-xs text-[#827299]">Program konsultasi & kesehatan mental tim/karyawan instansi</p>
                            </div>
                        </button>
                        ...
                        <button type="button"
                            ...
                            <div class="flex-1 min-w-0">
                                ...
                                <p class="text-xs text-[#827299]">Asesmen rekrutmen, seleksi, promosi, dan pemetaan SDM</p>
                            </div>
                        </button>
                    </div>
                </div>
        ...
        <div class="flex items-center justify-end gap-3 pt-2">
            <a href="{{ route('bookings.index') }}" class="px-6 py-2.5 text-sm font-semibold text-[#6B5B85] border border-[#D9C2F0] rounded-xl hover:bg-[#F7F5FB] transition">
                Batal
            </a>
