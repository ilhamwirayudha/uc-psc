...
export const citiesByProvince = {
    ...
    'Kalimantan Tengah': [
        ...
        'Kab. Murung Raya', 'Kab. Pulang Pisau', 'Kab. Sukamara', 'Kab. Seruyan'
    ],
    'Kalimantan Selatan': [
    ...
    'Sulawesi Selatan': [
        ...
        'Kab. Maros', 'Kab. Pangkajene dan Kepulauan', 'Kab. Pinrang', 'Kab. Sidenreng Rappang',
    ...
    'Papua': [
        ...
        'Kab. Sarmi', 'Kab. Supiori', 'Kab. Waropen'
    ],
    'Papua Barat': [
        'Manokwari',
...
export function addressSelector(initialCountry = '', initialProvince = '', initialCity = '') {
    return {
        ...
        openProvince() {
            ...
            this.cityOpen = false;
            this.$nextTick(() => {
                this.$refs.provinceSearchInput?.focus();
            });
        },
...
// Expose globally for inline scripts / Alpine
